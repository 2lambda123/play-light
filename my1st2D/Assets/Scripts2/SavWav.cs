...
public static class SavWav {
    ...
    public static void WriteString(string filename, string myoutString){
	...
	public static bool Save(string filename, AudioClip clip) {
		if (!filename.ToLower().EndsWith(".wav")) {
			filename += ".wav";
             // filename += System.DateTime.Now.ToString("$$anonymous$$$$anonymous$$-dd-yy_hh-mm-ss") +".wav"; 
		}
